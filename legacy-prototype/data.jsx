...
const SIMS = [
  ...
  { id: 'integer-arithmetic', title: 'Integer Arithmetic', subject: 'Math', grade: 'Class 9', chapter: 'Integers', level: 'Core', minutes: 8, concepts: ['Integers', 'Addition', 'Subtraction'], featured: false, new: true },
